...
impl NpmPackageResolver {
    ...
    pub async fn add_package_reqs(&self, packages: Vec<NpmPackageReq>) -> Result<(), AnyError> {
    ...
    pub async fn set_package_reqs(&self, packages: Vec<NpmPackageReq>) -> Result<(), AnyError> {
