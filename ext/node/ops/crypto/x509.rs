...
#[op2]
#[cppgc]
pub fn op_node_x509_parse(#[buffer] buf: &[u8]) -> Result<Certificate, AnyError> {
    ...
    let inner = Yoke::<CertificateView<'static>, Box<CertificateSources>>::try_attach_to_cart(
        Box::new(source),
        |source| {
...
#[op2]
#[string]
pub fn op_node_x509_fingerprint(#[cppgc] cert: &Certificate) -> Result<Option<String>, AnyError> {
...
#[op2]
#[string]
pub fn op_node_x509_get_issuer(#[cppgc] cert: &Certificate) -> Result<String, AnyError> {
    let cert = cert.inner.get().deref();
...
#[op2]
#[string]
pub fn op_node_x509_get_subject(#[cppgc] cert: &Certificate) -> Result<String, AnyError> {
    let cert = cert.inner.get().deref();
...
#[op2]
#[cppgc]
pub fn op_node_x509_public_key(#[cppgc] cert: &Certificate) -> Result<KeyObjectHandle, AnyError> {
    let cert = cert.inner.get().deref();
...
#[op2]
#[string]
pub fn op_node_x509_get_valid_from(#[cppgc] cert: &Certificate) -> Result<String, AnyError> {
    let cert = cert.inner.get().deref();
...
#[op2]
#[string]
pub fn op_node_x509_get_valid_to(#[cppgc] cert: &Certificate) -> Result<String, AnyError> {
    let cert = cert.inner.get().deref();
...
#[op2]
#[string]
pub fn op_node_x509_get_serial_number(#[cppgc] cert: &Certificate) -> Result<String, AnyError> {
    let cert = cert.inner.get().deref();
...
#[op2(fast)]
pub fn op_node_x509_key_usage(#[cppgc] cert: &Certificate) -> Result<u16, AnyError> {
    let cert = cert.inner.get().deref();
    let key_usage = cert
        .extensions()
        .iter()
