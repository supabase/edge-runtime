...
impl KeyObjectHandle {
    pub fn sign_prehashed(
        ...
        match private_key {
            ...
            AsymmetricPrivateKey::Dsa(key) => {
                ...
                let signature = res.map_err(|_| generic_error("failed to sign digest with DSA"))?;
                Ok(signature.into())
            }
            ...
            AsymmetricPrivateKey::Dh(_) => Err(type_error("DH key cannot be used for signing")),
        }
    }
    ...
    pub fn verify_prehashed(
        ...
        match &*public_key {
            ...
            AsymmetricPublicKey::Dh(_) => Err(type_error("DH key cannot be used for verification")),
        }
    }
}
