...
deno_core::extension!(deno_node,
  ...
  esm = [
    ...
    // "internal/dtrace.ts",
    "internal/error_codes.ts", // [not used]
    // "internal/errors.ts", // [not used]
    // "internal/event_target.mjs",
    // "internal/fixed_queue.ts",
    // "internal/fs/streams.mjs",
    // "internal/fs/utils.mjs",
    "internal/hide_stack_frames.ts", // [not used]
    // "internal/http.ts",
    // "internal/idna.ts",
    // "internal/net.ts",
    "internal/normalize_encoding.mjs", // [not used]
    // "internal/options.ts",
    ...
    // "internal/util/inspect.mjs", // [not used]
    "internal/util/types.ts", // [not used]
    "internal/validators.mjs", // [not used]
    // "net.ts",
    // "os.ts",
    // "path.ts",
    // "path/_constants.ts",
