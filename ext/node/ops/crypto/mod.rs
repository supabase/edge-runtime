...
#[op2(fast)]
pub fn op_node_decipheriv_take(state: &mut OpState, #[smi] rid: u32) -> Result<(), AnyError> {
...
pub fn op_node_sign(
    ...
    handle.sign_prehashed(digest_type, digest, pss_salt_length, dsa_signature_encoding)
}
...
pub fn op_node_diffie_hellman(
    ...
    let res = match (private, &*public) {
        ...
        ) => p224::ecdh::diffie_hellman(private.to_nonzero_scalar(), public.as_affine())
            .raw_secret_bytes()
            .to_vec()
            .into_boxed_slice(),
        (
        ...
        (
            ...
            .to_vec()
            .into_boxed_slice(),
        (AsymmetricPrivateKey::X25519(private), AsymmetricPublicKey::X25519(public)) => private
